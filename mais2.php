...
function load(data, id) {
    ...
    if(id == data.id){
         ...
         line += '<div class="card" > <div class="card-body">' +
        ...
        line += 
        '<p><button id="' + data.id + '" class="btn btn-success btn-atender">Obter</button></p>' +
        '</div></div>';
